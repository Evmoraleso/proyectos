...
from corredora.services.comuna import obtener_comuna, obtener_comunas
from corredora.services.estadoInmueble import obtener_estado_inmueble, obtener_estado_inmuebles
from corredora.services.tipoInmueble import obtener_tipo_inmueble, obtener_tipo_inmuebles
...
def listar_inmuebles_disponibles(request):
    ...
    return render(request, 'arrendatario/listar_inmuebles_disponibles.html', {'inmuebles': inmuebles, 'usuario': usuario})
